...
public class MovieServiceTest {
    ...
    void setUp(){
        ...
        testDto.setActorNames(Set.of("Leonardo"));
    ...
    void findById_shouldReturnEmpty_whenNotFound(){
        ...
        Optional<Movie> foundMovie=movieService.findById(2L);
    ...
    void findByWatchTrue_ShouldReturnMovies(){
        ...
        List<Movie> watchedMovie=movieService.findByWatchedTrue();
        assertFalse(watchedMovie.isEmpty());
    ...
    void findByRatingGreaterThan_ShouldReturnMovies(){
        ...
        List<Movie> ratedMovies=movieService.findByRatingGraterThan(8.0);
...
@Test
    void addMovieToWatchList_ShouldThrowException_WhenEmailFails() throws EmailSendingException {
        when(movieRepo.findById(1L)).thenReturn(Optional.of(testMovie));
        when(movieRepo.save(testMovie)).thenReturn(testMovie);
        doThrow(new EmailSendingException("Failed to send email")).when(emailService)
...
//    private Movie testMovie = createMovie();
//
